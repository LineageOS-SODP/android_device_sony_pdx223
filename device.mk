...
# Device path
DEVICE_PATH := device/sony/pdx223/rootdir

DEVICE_PACKAGE_OVERLAYS += \
    device/sony/pdx223/overlay
...
# Touch firmware
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/vendor/firmware/touch_module_id_0x46.img:$(TARGET_COPY_OUT_VENDOR)/firmware/touch_module_id_0x46.img
...
PRODUCT_PACKAGES += \
    fstab.pdx223 \
    ramdisk-fstab.pdx223 \
    init.recovery.pdx223 \
    init.pdx223
